...
function(r) {
    ...
    function n(r, t, e) {
        ...
        d = l + u,
        h = .01;
        1 === e.mode ? r.addBlank(0, l - h, n, d + h) : r.addBlank(c - h, l - h, s + h, d + h),
    ...
    function o(r, t, e) {
        ...
        s = c + a,
        d = .01;
        3 === e.mode ? r.addBlank(0, c - d, n, s + d) : r.addBlank(f - d, c - d, l + d, s + d),
    ...
    var r = function() {
        ...
        var t = function(t, e) {
            ...
            y = function() {
                ...
                e = 0; 8 > e; e += 1) {
                    m(!0, e);
                    var n = i.getLostPoint(p); (0 == e || r > n) && (r = n, t = e)
                }
                return t
            },
            E = function() {
            ...
            C = function(r, t) {
                ...
                o = 7,
                a = 0,
                u = i.getMaskFunction(t), f = h - 1; f > 0; f -= 2) for (6 == f && (f -= 1);;) {
            ...
            M = function(t, e) {
                ...
                for (var p = 0,
                d = 0; d < e.length; d += 1) p += e[d].totalCount;
            ...
            b = function(r, t, e) {
                for (var n = u.getRSBlocks(r, t), c = f(), l = 0; l < e.length; l += 1) {
                    var s = e[l];
                    c.put(s.getMode(), 4),
                    c.put(s.getLength(), i.getLengthInBits(s.getMode(), r)),
                    s.write(c)
                }
                for (var d = 0,
                l = 0; l < n.length; l += 1) d += n[l].dataCount;
        ...
        u = function() {
            ...
            return e.getRSBlocks = function(r, e) {
                ...
                a = new Array,
                u = 0; i > u; u += 1) for (var f = n[3 * u + 0], c = n[3 * u + 1], l = n[3 * u + 2], s = 0; f > s; s += 1) a.push(t(c, l));
                return a
            },
            e
        } (),
        ...
        h = function(r, t) {
            ...
            u = function(r) {
                ...
                for (d += 1; d < o.length;) {
                    ...
                    d += 1,
                    i.contains(h + g) ? h += g: (s.write(i.indexOf(h), n), i.size() < 4095 && (i.size() == 1 << n && (n += 1), i.add(h + g)), h = g)
                }
...
function(r) {
    r.fn.share = function(t, e) {
        ...
        function i(r, t) {
            return "string" == typeof r && (r = r.split(",")),
